...
import by.http.accounting.Accounting;
import by.http.food.Food;
import by.http.transport.Transport;

public abstract class Trip implements Accounting {
	...
	// method to calculate trip cost using transport cost, service cost, food cost
	public int costCalc() {
		int finalCost = 0;
