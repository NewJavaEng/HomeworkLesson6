...
public class Main {
	...
	public static void main(String[] args) {
		...
		// constructor is used from Bus class
		// String name, int transferCost, int placeCount, int stopCount
		...
		// int tripDuration, Food[] food, Transport[] transport, int serviceCost, int citiesCount, String emotion
		...
		// int tripDuration, Food[] food, Transport[] transport, int serviceCost, int citiesCount, int portsCount
		...
		// int tripDuration, Food[] food, Transport[] transport, int serviceCost, String resortName
		...
		// int tripDuration, Food[] food, Transport[] transport, int serviceCost, String cityName
